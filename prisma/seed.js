...
async function main() {
  ...
  const projectDetails = {
    'ono-opo': {
      ...
      metrics: [{ label: 'BRD', value: '49', unit: 'pages' }, { label: 'FRD', value: '120', unit: 'pages' }, { label: 'Stakeholder validation', value: '100', unit: '%' }],
  ...
  const experience = await prisma.experience.upsert({ where: { slug: 'pt-aman-media-interaktif' }, update: {}, create: { company: 'PT Aman Media Interaktif', role: 'Business Analyst Intern', slug: 'pt-aman-media-interaktif', employmentType: EmploymentType.INTERNSHIP, startDate: date('2025-06-30'), endDate: date('2025-10-24'), summary: 'Business analysis internship involving requirements, process analysis, validation, and QA evidence.', responsibilities: ['Requirements analysis','Process analysis','Validation and testing'], featured: true } })
  ...
  await prisma.achievement.upsert({ where: { slug: 'kmipn-vii-2025-teamup' }, update: {}, create: { title: 'KMIPN VII 2025 — Juara 2 Umum Cipta Inovasi Bidang TIK', slug: 'kmipn-vii-2025-teamup', organization: 'KMIPN VII', category: AchievementCategory.COMPETITION, date: date('2025-01-01'), result: 'Juara 2 Umum', credential: 'HAKI 000984870', featured: true } })
